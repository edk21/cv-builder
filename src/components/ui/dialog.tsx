  ...
  return (
    <DialogPortal>
      ...
      <div
        ref={ref}
        className={cn(
          "fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border bg-background p-6 shadow-xl rounded-xl animate-in fade-in-0 zoom-in-95 duration-200",
          className
        )}
